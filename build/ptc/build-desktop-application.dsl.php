...
RunCommand execute
  label "Add our back end application variable set, {{{ param::start-dir }}}/vars/configuration_devcloud.php {{{ param::start-dir }}}/clients/desktop/core/ && mv {{{ param::start-dir }}}/clients/web/core/configuration_devcloud.php {{{ param::start-dir }}}/clients/web/core/app_vars.fephp"
  command "cp {{{ param::start-dir }}}/vars/configuration_devcloud.php {{{ param::start-dir }}}/clients/desktop/core/ && mv {{{ param::start-dir }}}/clients/web/core/configuration_devcloud.php {{{ param::start-dir }}}/clients/web/core/app_vars.fephp"
  guess
  when "$$custom_branch"
  equals "development"

RunCommand execute
  label "Add our back end application variable set, {{{ param::start-dir }}}/vars/configuration_$$custom_branch.php {{{ param::start-dir }}}/clients/web/core/ && mv {{{ param::start-dir }}}/clients/web/core/configuration_$$custom_branch.php {{{ param::start-dir }}}/clients/web/core/app_vars.fephp"
  command "cp {{{ param::start-dir }}}/vars/configuration_$$custom_branch.php {{{ param::start-dir }}}/clients/web/core/ && mv {{{ param::start-dir }}}/clients/web/core/configuration_$$custom_branch.php {{{ param::start-dir }}}/clients/web/core/app_vars.fephp"
  guess
